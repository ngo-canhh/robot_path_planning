...
import numpy as np
import math
from utils.metrics_display import print_metrics, visualize_metrics, radar_chart
import os
import pickle
import importlib
import sys
...
def get_controller_class(algorithm):
    ...
    """
    if algorithm == 'rrt':
        module_name = 'controllers.indoor_robot_controller_rrt'
    elif algorithm == 'bb_orca':
        module_name = 'controllers.indoor_robot_controller_bb_orca'
    elif algorithm == 'raytracing_waitingrule':
        module_name = 'controllers.indoor_robot_controller_raytracing_waitingrule'
    else:
    ...
    try:
        ...
        from controllers.indoor_robot_controller_bb_orca import IndoorRobotController
...
if __name__ == "__main__":
    ...
    results_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), f"results/map_results_{config['algorithm']}")
