...
import math
import numpy as np
from robot_env.indoor_robot_env import IndoorRobotEnv # Assuming this exists
...
from utils.pyorca import Agent as OrcaAgent # Rename to avoid conflict if needed
from utils.pyorca import orca as calculate_orca_velocity
from utils.halfplaneintersect import InfeasibleError
# --- End ORCA Imports ---
...
class IndoorRobotController:
    ...
    def _calculate_path_following_action(self, robot_x, robot_y, robot_velocity_magnitude, robot_orientation, perceived_static_obstacles):
        ...
        steering_vel_factor = max(0.0, np.cos(norm_steer_mag * np.pi / 2))
